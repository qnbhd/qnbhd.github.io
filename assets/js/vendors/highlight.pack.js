  ...
  return (function (n) {
    ...
    function p(e, n, r, i) {
        ...
        if (((f = t), "begin" === t.type))
          return (function (e) {
            ...
            return t.__onBegin && (t.__onBegin(e) || {}).ignoreMatch
              ...
              : (t && t.endSameAsBegin && (t.endRe = RegExp(n.replace(/[-\/\\^$*+?.()|[\]{}]/g, "\\$&"), "m")),
                t.skip ? (k += n) : (t.excludeBegin && (k += n), c(), t.returnBegin || t.excludeBegin || (k = n)),
                h(t),
                t.returnBegin ? 0 : n.length);
          })(t);
        if ("illegal" === t.type && !r)
          throw (
            ((a = Error('Illegal lexeme "' + i + '" for mode "' + (_.className || "<unnamed>") + '"')).mode = _),
            a
          );
        if ("end" === t.type) {
          var l = (function (e) {
      ...
      !(function (e) {
        ...
        class a {
          ...
          exec(e) {
            ...
            let t = n.exec(e);
            return (
              t && ((this.regexIndex += t.position + 1), this.regexIndex === this.count && (this.regexIndex = 0)),
              t
            );
          }
        }
        ...
        !(function r(s, o) {
          s.compiled ||
            ...
            o &&
              (s.beginKeywords &&
                ((s.begin = "\\b(" + s.beginKeywords.split(" ").join("|") + ")(?=\\b|\\s)"), (s.__onBegin = i)),
              s.begin || (s.begin = /\B|\b/),
              (s.beginRe = n(s.begin)),
      ...
      try {
        ...
        for (
          ...
          A ? (A = !1) : ((_.matcher.lastIndex = L), _.matcher.considerAll()), (y = _.matcher.exec(s));
    ...
    function v(e) {
      ...
      h(o) ||
        ...
        (s = n.textContent),
        (r = o ? f(o, s, !0) : m(s)),
        (t = y(n)).length && (((a = document.createElement("div")).innerHTML = r.value), (r.value = O(t, y(a), s))),
        (r.value = b(r.value)),
  ...
  (function () {
    ...
    return function (e) {
      var t = "[^\\(\\)\\[\\]\\{\\}\",'`;#|\\\\\\s]+",
        ...
        o = {
          variants: [{ begin: /'/ }, { begin: "`" }],
          contains: [{ begin: "\\(", end: "\\)", contains: ["self", n, r, a, c, s] }],
        },
        u = {
          className: "name",
          begin: t,
      ...
      return (
        (l.contains = [n, a, r, c, s, o, g].concat(i)),
        {
          name: "Scheme",
          illegal: /\S/,
          contains: [{ className: "meta", begin: "^#!", end: "$" }, a, r, s, o, g].concat(i),
        }
      );
    };
  })(),
  ...
  (function () {
    ...
    return function (e) {
      ...
      return (
        (t.contains = a),
        (s.contains = a),
        { name: "Perl", aliases: ["pl", "pm"], lexemes: /[\w\.]+/, keywords: n, contains: a }
      );
    };
  })(),
);
...
hljs.registerLanguage(
  ...
  (function () {
    ...
    return function (n) {
      ...
      return ((e.contains = c), (a.contains = c), { name: "Prolog", contains: c.concat([{ begin: /\.$/ }]) });
    };
  })(),
);
hljs.registerLanguage(
  ...
  (function () {
    ...
    return function (e) {
      var n = "[a-zA-Z_\\-\\+\\*\\/\\<\\=\\>\\&\\#][a-zA-Z0-9_\\-\\+\\*\\/\\<\\=\\>\\&\\#!]*",
        ...
        c = {
          contains: [s, b, l, t, { begin: "\\(", end: "\\)", contains: ["self", i, b, s, r] }, r],
          variants: [
            { begin: "['`]\\(", end: "\\)" },
      ...
      return (
        (o.contains = [{ className: "name", variants: [{ begin: n }, { begin: "\\|[^]*?\\|" }] }, m]),
        (m.contains = [c, d, o, i, s, b, g, l, t, { begin: "\\|[^]*?\\|" }, r]),
        {
          name: "Lisp",
          illegal: /\S/,
          contains: [s, { className: "meta", begin: "^#!", end: "$" }, i, b, g, c, d, o, r],
        }
      );
    };
  })(),
