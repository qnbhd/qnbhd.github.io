...
var hljs = (function () {
        ...
        function w(a, r) {
          ...
          if (((y = r), "begin" === r.type))
            return ((e) => {
              ...
              return (
                a.skip ? (S += t) : (a.excludeBegin && (S += t), d(), a.returnBegin || a.excludeBegin || (S = t)),
                b(a, e),
  ...
  function ve(e) {
    ...
    const _ = [].concat(m, c.contains),
      ...
      v = {
        match: n.concat(
          /\b/,
          ((N = [...Ee, "super", "import"].map((e) => e + "\\s*\\(")), n.concat("(?!", N.join("|"), ")")),
          t,
          n.lookahead(/\s*\(/),
        ),
              ...
              contains: [
                {
                  ...
                  variants: [
                    ...
                    { begin: /(\s*)\(/, end: /\)/, excludeBegin: !0, excludeEnd: !0, keywords: i, contains: h },
                  ],
                },
              ],
            },
  ...
  var Ue = Object.freeze({
    ...
    grmr_perl: (e) => {
      ...
      return ((i.contains = b), (r.contains = b), { name: "Perl", aliases: ["pl", "pm"], keywords: a, contains: b });
    },
    grmr_php: (e) => {
      const n = e.regex,
        t = /(?![A-Za-z0-9])(?![$])/,
        ...
        w = { relevance: 0, begin: /\(/, end: /\)/, keywords: p, contains: [y, s, E, e.C_BLOCK_COMMENT_MODE, d, g, h] },
        v = {
          relevance: 0,
          match: [
            /\b/,
    ...
    grmr_swift: (e) => {
      const n = { match: /\s+/, relevance: 0 },
        ...
        M = (e) => {
          const n = b(e, /\//),
            t = b(/\//, e);
          return { begin: n, end: t, contains: [...x, { scope: "comment", begin: `#(?!.*${t})`, end: /$/ }] };
        },
        A = {
          scope: "regexp",
          variants: [M("###"), M("##"), M("#"), O],
        ...
        S = { match: b(/`/, $e, /`/) },
        C = [S, { className: "variable", match: /\$\d+/ }, { className: "variable", match: `\\$${Be}+` }],
        T = [
          {
            match: /(@|#(un)?)available/,
            scope: "keyword",
        ...
        R = {
          ...
          relevance: 0,
          contains: [
            { className: "type", match: b(/(AV|CA|CF|CG|CI|CL|CM|CN|CT|MK|MP|MTK|MTL|NS|SCN|SK|UI|WK|XC)/, Be, "+") },
