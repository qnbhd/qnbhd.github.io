!(function (r, o) {
  ...
  function u(e) {
    ...
    var a,
      l = t.textContent,
      s = r.textContent;
    for (i < o && ((a = o), (o = i), (i = a), (a = l), (l = s), (s = a)); 0 !== n.indexOf(l); ) l = l.slice(1);
    ...
    return (
      (function e(n) {
        ...
        for (var r in t) {
          ...
          t.hasOwnProperty(r) &&
            ((o = t[r]),
            0 < (o.textContent.trim().match(i) || []).length && (0 < o.childNodes.length ? e(o) : v(o.parentNode)));
        }
      })(e),
      (function (e, n) {
        var t = g(e);
        ...
        if (1 < t.length || n.singleLine) {
          ...
          return p('<table class="{0}">{1}</table>', [a, r]);
        }
        return e;
      })(e.innerHTML, o)
    );
  ...
  (r.hljs
    ? ((r.hljs.initLineNumbersOnLoad = function (e) {
      ...
      (r.hljs.lineNumbersBlockSync = function (e, n) {
      ...
      (e.innerHTML = p(".{0}{border-collapse:collapse}.{0} td{padding:0}.{1}:before{content:attr({2})}", [a, c, m])),
