      ...
      contains: [
        { className: "literal", match: "(true|false|null|undefined)" },
        {
          ...
          contains: [
            {
              className: "string",
              variants: [{ match: "\\\\([nrt'\"\\\\]|(x[0-9a-fA-F]{2})|(u\\{[0-9a-fA-F]+\\}))" }, { match: "\\\\." }],
              relevance: 0,
            },
          ],
          relevance: 0,
        ...
        },
        {
          ...
          variants: [
            ...
            { match: "\\b(bool|void|noreturn|type|anyerror|anyframe|anytype)\\b", relevance: 0 },
          ],
        },
        {
          className: "function",
          variants: [{ beginKeywords: "fn", end: "([_a-zA-Z][_a-zA-Z0-9]*)", excludeBegin: true }],
          relevance: 0,
        },
        {
          className: "built_in",
